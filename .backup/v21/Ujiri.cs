        ...
        pakhiBot.SetProfile(new IProfile()
{
    ...
    psythicBot = Game.CreatePlayer(xrayBot.GetWorldPosition());
    if (psythicBot != null)
    {
        ...
        psythicMods.SizeModifier = 0.5f; // Smaller size (kid)
        psythicMods.RunSpeedModifier = 0.6f;
        psythicMods.SprintSpeedModifier = 0.7f;
...
private void SetPsythicHungry()
{
    ...
    psythicMods.SprintSpeedModifier = 5f;
    psythicBot.SetModifiers(psythicMods);
