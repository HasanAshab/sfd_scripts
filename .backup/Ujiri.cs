        ...
        pakhiBot.SetProfile(new IProfile()
{
    ...
    if (psythicBot != null)
    {
        ...
        psythicBot.SetBotBehavior(new BotBehavior(true, PredefinedAIType.DebugBot)); // Start full (non-aggressive)
...
private void SetPsythicFull()
{
    ...
    // Change behavior to DebugBot (non-aggressive)
    psythicBot.SetBotBehavior(new BotBehavior(true, PredefinedAIType.DebugBot));
...
private void SetPsythicHungry()
{
    ...
    // Change behavior to ZombieB (aggressive)
