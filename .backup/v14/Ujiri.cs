...
public void SetupBots()
{
    ...
    if (timpaBot != null)
    {
        ...
        timpaBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
    ...
    if (bichiBot != null)
    {
        ...
        bichiBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
        bichiBot.SetProfile(new IProfile()
{
    ...
    if (kokolaBot != null)
    {
        ...
        kokolaBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
        kokolaBot.SetProfile(new IProfile()
{
    ...
    if (edurBot != null)
    {
        ...
        edurBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
    ...
    if (xrayBot != null)
    {
        ...
        xrayBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
    ...
    if (pakhiBot != null)
    {
        ...
        pakhiBot.SetCameraSecondaryFocusMode(CameraSecondaryFocusMode.Ignore);
